...
# test command
PHPUNIT-PARAMS ?=
phpunit-no-coverage := ./vendor/bin/phpunit --no-coverage $(PHPUNIT-PARAMS)
phpunit-coverage := ./vendor/bin/phpunit --coverage-text $(PHPUNIT-PARAMS)
phpunit-coverage-html := ./vendor/bin/phpunit $(PHPUNIT-PARAMS)
