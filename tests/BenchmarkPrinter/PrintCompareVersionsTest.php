...
| Foo group                                                                                                        |
+--------------------------------+---------+-------+-------+-------------+-------------+-------------+-------------+
|    Lorem ipsum dolor sit amet, |  v1.0.0 | 2     | 2     | 170 B       | 270 B       | 170 B       | 7.39 ns     |
|   consectetur adipiscing elit. +---------+-------+-------+-------------+-------------+-------------+-------------+
|    Cras porta eleifend ante ut | v2.0.x… | 2     | 2     | 100 B       | 0 B         | 0 B         | 6.18 ns     |
|                       maximus. |         |       |       |             |             |             |             |
+--------------------------------+---------+-------+-------+-------------+-------------+-------------+-------------+
|     Lorem ipsum dolor sit amet |  v1.0.0 | 2     | 2     | 16 B        | 0 B         | 0 B         | 2.395 ns    |
|                                +---------+-------+-------+-------------+-------------+-------------+-------------+
|                                | v2.0.x… | 2     | 2     | 60 B        | 0 B         | 60 B        | 1.705 ns    |
+--------------------------------+---------+-------+-------+-------------+-------------+-------------+-------------+
');
